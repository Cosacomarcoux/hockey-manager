...
FORMACIONES = {
    ...
    # 1-3-3-3: stopper + 3 defensoras + 3 volantes + 3 delanteras (el stopper cuenta como defensora)
    "1-3-3-3": {Posicion.ARQUERA: 1, Posicion.DEFENSORA: 4, Posicion.VOLANTE: 3, Posicion.DELANTERA: 3},
    # 3-4-3: 3 defensoras + 4 volantes + 3 delanteras
    "3-4-3": {Posicion.ARQUERA: 1, Posicion.DEFENSORA: 3, Posicion.VOLANTE: 4, Posicion.DELANTERA: 3},
}
